...
// Fecha (sin hora) de un instante ISO, en Europe/Madrid — para no mostrar el
// día siguiente/anterior a un dispositivo en otro huso horario cerca de
// medianoche.
export function formatDateEs(iso: string): string {
  return new Intl.DateTimeFormat("es-ES", { timeZone: "Europe/Madrid" }).format(new Date(iso));
}
